...
import {HomeIcon, ShipWheelIcon, BellIcon, UsersIcon} from "lucide-react";
...
const SidebarComponent = () => {
    ...
    return (
        <aside className="w-64 bg-base-200 h-screen border-r border-base-300 hidden lg:flex flex-col sticky-top-0">
